      ...
      <div className='max-w-[1320px] mx-auto px-3 pt-[68px] pb-[155px]'>
        ...
        <div className='grid grid-cols-3 gap-[25px]'>
          {EVENT_CARD_DATA.map((item, index) => (
            <div key={index} className='border border-[#CCCCCC] rounded-[30px] pt-[35px] pb-[30px] group px-[40px] hover:border-0 hover:shadow-eventcard'>
              <img src={item.image} alt="image" className='group-hover:rounded-none rounded-[20px]' />
