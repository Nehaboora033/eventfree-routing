    ...
    return (
        <div className='bg-center bg-cover bg-no-repeat pb-[104px] ' style={{ backgroundImage: `url(${backgroundImage})` }} >
            <div className='max-w-[1320px] mx-auto sm:pt-[256px] pt-[200px] px-3 '>
                ...
                <div className='flex sm:gap-[23px] gap-4 items-center min-[730px]:mb-[145px] mb-[110px] '>
                    <Button
                        buttonText={'Get Started'}
                        className='py-[11px] px-7 text-[20px] leading-[150%] ' />

                    <Link className='font-poppins font-normal text-[20px] whitespace-nowrap text-white '>
                        Learn more
                    </Link>
                </div>
